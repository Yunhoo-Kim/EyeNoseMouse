...
import com.hooitis.hoo.eyenosemouse.BuildConfig
...
import com.hooitis.hoo.eyenosemouse.utils.FIREBASE_VERSION_DB
...
class VersionsRepository @Inject constructor(val versionsDao: VersionsDao,
    ...
    fun loadVersionFromServer(): Observable<Versions> {
        return Observable.create { emitter ->
            firebaseStore.collection(FIREBASE_VERSION_DB).document(FIREBASE_VERSION_DB)
                    .get()
